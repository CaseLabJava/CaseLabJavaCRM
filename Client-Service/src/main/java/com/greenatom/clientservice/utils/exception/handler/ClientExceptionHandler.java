package com.greenatom.clientservice.utils.exception.handler;

import com.greenatom.clientservice.utils.exception.ClientException;
import com.greenatom.clientservice.utils.exception.message.ErrorMessage;
...
public class ClientExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleClientException(ClientException e) {
        ...
        HttpStatus status = switch (code) {
            ...
            case INCORRECT_ATTRIBUTE_NAME -> null;
        };
