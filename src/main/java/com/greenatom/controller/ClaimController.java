...
public class ClaimController implements ClaimApi {
    ...
    public List<ClaimResponseDTO> getClaimsResponse(
            @RequestParam(defaultValue = "0") Integer pageNumber,
            @RequestParam(defaultValue = "10") Integer pageSize) {
        return claimService.findUnassignedClaims(pageNumber, pageSize);
    }
    ...
    @PreAuthorize(value = "hasRole('ROLE_MANAGER')")
    public ClaimResponseDTO addClaim(@RequestBody ClaimRequestDTO claim) {
